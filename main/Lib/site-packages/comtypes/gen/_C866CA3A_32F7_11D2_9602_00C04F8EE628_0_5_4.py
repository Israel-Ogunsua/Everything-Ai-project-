...
__all__ = [
    'DISPID_SPRFirstElement', 'DISPID_SGRAddState', 'SPSFunction',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPRDisplayAttributes', 'SLODynamic', 'SVPNormal',
    'LONG_PTR', 'SVEEndInputStream', 'ISpeechCustomStream',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRSTsCount',
    'SGPronounciation', 'SBONone', 'DISPID_SLWsItem',
    'SpeechCategoryVoices', 'DISPID_SRGDictationUnload',
    'DISPID_SASNonBlockingIO', 'DISPID_SOTSetId', 'DISPID_SGRSTType',
    'ISpeechPhraseProperties', 'DISPID_SRGCmdLoadFromFile',
    'SRATopLevel', 'DISPID_SVEBookmark', 'DISPID_SAFGuid',
    'SPCT_SUB_DICTATION', 'DISPID_SVVoice', 'SPPHRASERULE',
    'DISPID_SLPsItem', 'SpeechRecoEvents', 'DISPID_SWFEExtraData',
    'SP_VISEME_7', 'SPEI_MIN_SR', 'SVSFDefault',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPPS_Noun',
    'SPSHT_OTHER', 'SPGRAMMARSTATE', 'SREAudioLevel', 'SVP_12',
    'DISPID_SRCERequestUI', 'SVEStartInputStream', 'SP_VISEME_0',
    'DISPID_SMSGetData', 'ISpeechFileStream',
    'DISPID_SDKGetlongValue', 'SPEI_UNDEFINED', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPARecoResult', 'DISPID_SGRName',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SRTAutopause',
    'DISPID_SVSLastResult', 'DISPID_SpeechMemoryStream',
    'SPEI_HYPOTHESIS', 'SPEI_PHRASE_START', 'SPPHRASEPROPERTY',
    'DISPID_SCSBaseStream', 'SPINTERFERENCE_TOOSLOW',
    'SPSEMANTICERRORINFO', 'DISPID_SOTCreateInstance', 'SVPAlert',
    'SpCustomStream', 'SPAR_Medium', 'SpeechPropertyResponseSpeed',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRSTransitions',
    'SPGS_DISABLED', 'DISPID_SVSInputWordLength', 'DISPID_SVSpeak',
    'DISPID_SPANumberOfElementsInResult', 'SPBO_TIME_UNITS',
    'DISPID_SPPChildren', 'DISPID_SRRGetXMLResult', 'SVF_Emphasis',
    'SVEBookmark', 'SpResourceManager', 'SAFT48kHz8BitStereo',
    'SPDKL_CurrentConfig', 'SPDKL_DefaultLocation', 'SRSEIsSpeaking',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpRecoContext2',
    'SPEI_TTS_BOOKMARK', 'SP_VISEME_19', 'SAFT11kHz8BitMono',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SSFMCreateForWrite',
    'SGDisplay', 'SECFIgnoreKanaType', 'SREPrivate', 'SITooFast',
    'SVEWordBoundary', 'SPCONTEXTSTATE', 'ISpObjectToken',
    'SAFT16kHz16BitMono', 'DISPID_SPEsItem', 'IStream', 'SITooLoud',
    'SECFIgnoreWidth', 'SRAONone', 'SRTReSent',
    'DISPID_SVAudioOutput', 'DISPID_SFSOpen', 'SVP_0',
    'STSF_CommonAppData', 'DISPID_SDKEnumKeys', 'SVSFPersistXML',
    'SPLO_DYNAMIC', 'DISPID_SRAudioInput', 'DISPID_SBSRead',
    'DISPID_SpeechDataKey', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SOTCEnumerateTokens', 'SPVPRI_ALERT',
    'DISPID_SPIElements', 'DISPID_SRRecognizer',
    'DISPID_SLAddPronunciation', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SPAsItem', 'DISPID_SRSCurrentStreamNumber',
    'SPEI_MIN_TTS', 'SP_VISEME_21', 'SVEViseme', 'ISpeechLexicon',
    'SPEVENT', 'SAFT12kHz8BitStereo', 'ISpRecoGrammar',
    'DISPID_SGRSTs_NewEnum', 'SPSNotOverriden', 'SPEI_SR_BOOKMARK',
    'SPEI_FALSE_RECOGNITION', 'SpeechRegistryUserRoot',
    'SAFTADPCM_44kHzMono', 'SVF_Stressed', 'SpeechWordPronounceable',
    'SPFM_OPEN_READONLY', 'SAFTGSM610_44kHzMono',
    'eLEXTYPE_PRIVATE10', 'DISPID_SPPEngineConfidence',
    'ISpeechPhraseReplacement', 'DISPID_SRRAudio',
    'SAFT24kHz8BitStereo', 'DISPID_SGRSTPropertyId', 'SREStreamStart',
    'ISpeechPhraseRules', 'SVEPrivate', 'SPEI_END_INPUT_STREAM',
    'SAFTGSM610_8kHzMono', 'SPPS_LMA', 'DISPID_SPPValue',
    'DISPID_SPIGetText', 'DISPIDSPTSI_SelectionLength',
    'ISpeechObjectTokens', 'SpMMAudioEnum', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPIEnginePrivateData', 'SDTRule', 'SPSMF_SAPI_PROPERTIES',
    'eLEXTYPE_PRIVATE14', 'SAFT12kHz16BitMono', 'SAFT32kHz8BitMono',
    'SPVPRI_OVER', 'DISPID_SPRuleParent', 'eLEXTYPE_RESERVED8',
    'SPSERIALIZEDPHRASE', 'DISPID_SGRSTsItem', 'SPDKL_LocalMachine',
    'SVEAllEvents', 'ISpRecognizer', 'SVSFNLPSpeakPunc',
    'ISpeechPhraseInfoBuilder', 'STCRemoteServer', 'DISPID_SPPsItem',
    'SPGRAMMARWORDTYPE', 'DISPID_SPRsItem', 'SP_VISEME_9',
    'ISpNotifySource', 'SAFT11kHz8BitStereo', 'SGSEnabled',
    'DISPID_SOTId', 'DISPID_SVVolume', 'ISpeechGrammarRules',
    'eLEXTYPE_PRIVATE7', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRCEInterference', 'DISPID_SDKOpenKey',
    'ISpeechObjectToken', 'SINoise', 'SpeechTokenValueCLSID',
    'ISpeechPhoneConverter', 'DISPID_SRCEventInterests',
    'SPPS_Interjection', 'DISPID_SWFEChannels', 'SPRST_NUM_STATES',
    'SVSFUnusedFlags', 'SVSFIsFilename', 'SAFT12kHz8BitMono',
    'DISPID_SRCEPropertyStringChange', 'SREAdaptation',
    'DISPID_SBSWrite', 'SPPS_NotOverriden',
    'DISPID_SpeechPhraseRules', 'DISPID_SPPName',
    'SAFTCCITT_uLaw_8kHzStereo', 'SAFTGSM610_11kHzMono', 'SPSUnknown',
    'ISpResourceManager', 'SPRECOCONTEXTSTATUS', 'SLTUser', 'SASStop',
    'eLEXTYPE_PRIVATE11', 'DISPID_SOTsItem',
    'SPWORDPRONUNCIATIONLIST', 'SPEI_REQUEST_UI',
    'DISPID_SVSLastBookmark', 'DISPID_SADefaultFormat',
    'ISpeechVoiceStatus', 'SPAO_NONE', 'eLEXTYPE_LETTERTOSOUND',
    'SpeechAudioFormatType', 'DISPID_SVSLastStreamNumberQueued',
    'SGSExclusive', 'DISPID_SRGState', 'SPEI_RECOGNITION',
    'DISPID_SOTGetDescription', 'SpeechVoiceSpeakFlags',
    'DISPID_SpeechAudioFormat', 'DISPID_SLAddPronunciationByPhoneIds',
    'ISpeechLexiconWord', 'SPBO_AHEAD', 'DISPID_SRRPhraseInfo',
    'SSSPTRelativeToStart', 'SPSMF_SRGS_SAPIPROPERTIES',
    'eLEXTYPE_PRIVATE8', 'SpeechPropertyNormalConfidenceThreshold',
    'SGRSTTDictation', 'ISpeechRecoResult', 'SP_VISEME_2',
    'SPPS_RESERVED3', 'DISPID_SGRsItem',
    'DISPID_SASCurrentDevicePosition', 'SpTextSelectionInformation',
    'SPSTREAMFORMATTYPE', 'DISPIDSPRG', 'SpeechBookmarkOptions',
    'SAFT48kHz16BitStereo', 'DISPID_SpeechObjectToken', 'SPAS_STOP',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SpeechLexiconWord',
    'SpeechRuleAttributes', 'DISPID_SpeechRecognizer',
    'SpeechTokenShellFolder', 'DISPID_SRRSetTextFeedback',
    'DISPID_SPIRetainedSizeBytes',
    'SpeechGrammarTagUnlimitedDictation', 'SPPHRASEREPLACEMENT',
    'DISPID_SGRsCommit', 'SpeechLexiconType',
    'DISPID_SPERetainedSizeBytes', 'SRERecoOtherContext',
    'SAFTDefault', 'SpPhoneConverter', 'SAFTCCITT_uLaw_22kHzMono',
    'ISpXMLRecoResult', 'SPEI_SOUND_END', 'DISPID_SLWs_NewEnum',
    'SAFT48kHz8BitMono', 'eLEXTYPE_RESERVED6', 'SpVoice',
    'ISpLexicon', 'SpeechVoiceCategoryTTSRate', 'SPEI_RESERVED1',
    'SSFMCreate', 'SpMemoryStream', 'DISPID_SVSRunningState',
    'SPEI_RESERVED6', 'SRTEmulated', 'DISPID_SRRGetXMLErrorInfo',
    'ISpeechRecoResultDispatch', 'SPVPRI_NORMAL', 'DISPID_SGRSRule',
    'SP_VISEME_13', 'SPWORDLIST', 'DISPID_SRGetPropertyString',
    'SPEI_START_SR_STREAM', 'SPRECOGNIZERSTATUS',
    'SPEI_START_INPUT_STREAM', 'SpeechInterference',
    'DISPID_SVIsUISupported', 'ISpeechGrammarRuleStateTransition',
    'SAFT11kHz16BitStereo', 'STCInprocHandler',
    'DISPID_SRCEEndStream', 'SPRS_INACTIVE', 'SAFT24kHz8BitMono',
    'DISPID_SGRId', 'SpeechDisplayAttributes', 'ISpNotifySink',
    'ISpeechLexiconPronunciation', 'SPCS_DISABLED', 'SRSActive',
    'ISpPhrase', 'SSTTDictation', 'SPVPRIORITY',
    'DISPID_SPPFirstElement', 'SVP_5',
    'DISPID_SRGCmdLoadFromResource', 'SRTExtendableParse',
    'ISpeechAudio', 'DISPID_SPRuleConfidence', 'SPRULE',
    'SDKLDefaultLocation', 'SpObjectToken',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRGSetTextSelection',
    'DISPID_SASState', 'SPPS_Modifier', 'SVSFVoiceMask',
    'DISPID_SPEActualConfidence', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'ISpObjectWithToken', 'DISPIDSPTSI_ActiveOffset',
    'SPBOOKMARKOPTIONS', 'tagSPTEXTSELECTIONINFO', 'SRSInactive',
    'ISpeechPhraseRule', 'SGSDisabled', 'ISpMMSysAudio',
    'SRSInactiveWithPurge', 'DISPID_SPIEngineId',
    'DISPID_SVGetAudioOutputs', 'SVP_19', 'SDTPronunciation',
    'DISPID_SOTGetStorageFileName', 'SREHypothesis',
    'DISPID_SRCEPropertyNumberChange', 'SpNullPhoneConverter',
    'ISpVoice', 'DISPID_SPIGetDisplayAttributes', 'DISPID_SVStatus',
    'SECFIgnoreCase', 'SPWT_DISPLAY', 'ISpeechPhraseReplacements',
    'DISPID_SWFEBitsPerSample', 'SPEI_SR_PRIVATE',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFTText', 'SRTStandard',
    'DISPID_SRCESoundStart', '_ISpeechRecoContextEvents',
    'SECFEmulateResult', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SOTCGetDataKey',
    'Speech_StreamPos_Asap', 'SDTAll', 'DISPID_SVEEnginePrivate',
    'DISPID_SRRTTickCount', 'SSTTWildcard',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SpShortcut',
    'SP_VISEME_12', 'SpStream', 'SAFT22kHz8BitStereo', 'SP_VISEME_16',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SRGId',
    'eLEXTYPE_RESERVED9', 'SDTAlternates', 'SREFalseRecognition',
    'DISPID_SpeechFileStream', 'ISpeechRecognizer',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRCPause', 'SPSMF_UPS',
    'SpeechRecoProfileProperties', 'SpeechUserTraining',
    'SpeechEngineProperties', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SDKCreateKey', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRGetFormat', 'DISPID_SGRSTNextState',
    'SpeechTokenIdUserLexicon', 'SPINTERFERENCE_NOISE',
    'SRAORetainAudio', 'DISPID_SRRAudioFormat', 'SPAUDIOSTATE',
    'DISPID_SOTRemove', 'ISpRecognizer3', 'SPVOICESTATUS',
    'DISPID_SRGRecoContext', 'SP_VISEME_18',
    'DISPID_SpeechMMSysAudio', 'SPPS_Noncontent',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRCEBookmark',
    'SRERequestUI', 'ISpeechDataKey', 'DISPID_SDKSetStringValue',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SpeechVoiceStatus',
    'DISPID_SOTCId', 'DISPID_SPAsCount',
    'DISPID_SRCRetainedAudioFormat', 'SECLowConfidence',
    'SDTProperty', 'eLEXTYPE_PRIVATE17', 'DISPID_SAFType',
    'SRCS_Disabled', 'SAFT12kHz16BitStereo', 'SPPS_Unknown',
    'Speech_Default_Weight', 'SpeechRecognizerState', 'ISpAudio',
    'SPPS_Function', 'SINone', 'DISPID_SVPause',
    'SpeechPropertyComplexResponseSpeed', 'SPXRO_Alternates_SML',
    'eLEXTYPE_PRIVATE3', 'SPSHT_Unknown', 'SASRun',
    'DISPID_SPRules_NewEnum', 'DISPID_SRRTStreamTime', 'STSF_AppData',
    'DISPID_SpeechLexicon', 'SITooSlow', 'DISPID_SRRRecoContext',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SpeechLexiconProns',
    'SPEI_MAX_TTS', 'SPEI_SOUND_START', 'DISPID_SOTGetAttribute',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPAStartElementInResult',
    'SAFT8kHz16BitMono', 'DISPID_SABIBufferSize',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPRulesCount',
    'ISpGrammarBuilder', 'eLEXTYPE_PRIVATE6', 'SREStateChange',
    'DISPID_SDKSetBinaryValue', 'SRADynamic',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPLOADOPTIONS', 'DISPID_SOTDataKey',
    '_ISpeechVoiceEvents', 'SPSEMANTICFORMAT',
    'DISPID_SpeechBaseStream', 'DISPID_SRCState', 'SPPARTOFSPEECH',
    'SRESoundStart', 'DISPID_SPRulesItem',
    'SpeechGrammarTagDictation', 'eLEXTYPE_PRIVATE13',
    'DISPID_SVSInputSentencePosition', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SBSFormat', 'SPWORD', 'SSFMOpenForRead',
    'DISPID_SOTCDefault', 'SDKLCurrentConfig', 'SAFT22kHz16BitStereo',
    'SpFileStream', 'SpeechRunState', 'DISPID_SRCEStartStream',
    'DISPID_SMSAMMHandle', 'SBOPause', 'DISPID_SRSetPropertyNumber',
    'SITooQuiet', 'DISPID_SVESentenceBoundary', 'SVP_17',
    'DISPID_SPERequiredConfidence', 'SPWORDTYPE',
    'SpeechTokenKeyFiles', 'SpeechPropertyLowConfidenceThreshold',
    'SVP_13', 'DISPID_SpeechPhraseElement', 'SVP_15', 'SREAllEvents',
    'SAFT8kHz8BitMono', 'SDKLCurrentUser', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SABIEventBias', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRCResume', 'DISPID_SpeechRecoResultTimes',
    'IInternetSecurityManager', 'DISPID_SLGenerationId',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRRTLength',
    'DISPID_SGRSTRule', 'eLEXTYPE_APP', 'DISPID_SRAudioInputStream',
    'SREPropertyNumChange', 'DISPID_SPAPhraseInfo',
    'ISpeechAudioBufferInfo', 'Speech_Max_Word_Length',
    'SPEI_VOICE_CHANGE', 'DISPID_SpeechGrammarRule',
    'DISPID_SGRSTWeight', 'STSF_LocalAppData',
    'DISPID_SOTRemoveStorageFileName', 'SAFT8kHz16BitStereo',
    'DISPID_SPPs_NewEnum', 'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRSAudioStatus',
    'eLEXTYPE_VENDORLEXICON', 'SpeechAudioVolume',
    'DISPID_SpeechAudio', 'DISPID_SVEWord', 'ISpeechRecoContext',
    'DISPID_SGRInitialState', 'DISPID_SAStatus',
    'DISPID_SRRDiscardResultInfo', 'SRAInterpreter',
    'ISpeechTextSelectionInformation', 'ISpNotifyTranslator',
    'SpeechVisemeFeature', 'DISPID_SRProfile', 'STCInprocServer',
    'SpeechGrammarWordType', 'SGDSActive',
    'DISPID_SRRTOffsetFromStart', 'SSSPTRelativeToEnd', 'SPSHT_EMAIL',
    'SRSEDone', 'eLEXTYPE_PRIVATE12', 'SpeechVisemeType',
    'SPSInterjection', 'SVP_4', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpStreamFormatConverter',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVSLastBookmarkId', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SVGetProfiles', 'SpeechRecognitionType',
    'SpeechGrammarState', 'DISPID_SOTsCount', 'STSF_FlagCreate',
    'SpLexicon', 'DISPID_SMSSetData', 'SPPHRASE',
    'DISPID_SpeechPhraseElements', 'SPAS_CLOSED',
    'SAFT24kHz16BitMono', 'DISPID_SRCEFalseRecognition',
    'DISPID_SOTCSetId', 'DISPID_SOTIsUISupported',
    'DISPID_SASetState', 'SPPS_RESERVED4', 'SVP_1',
    'DISPID_SpeechPhoneConverter', 'SSTTTextBuffer',
    'DISPID_SpeechPhraseReplacement', 'ISpStreamFormat',
    'SPEI_WORD_BOUNDARY', 'eLEXTYPE_USER_SHORTCUT',
    'SpPhraseInfoBuilder', 'SRESoundEnd', 'DISPID_SPRuleName',
    'SPWT_LEXICAL', 'ISpPhoneConverter', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SLPSymbolic', 'DISPID_SVEventInterests', 'SP_VISEME_1',
    'SDA_No_Trailing_Space', 'ISpeechGrammarRuleState',
    'DISPID_SVWaitUntilDone', 'SWPKnownWordPronounceable',
    'SpeechCategoryAudioIn', 'DISPID_SRCVoicePurgeEvent',
    'SVEVoiceChange', 'SPAR_Low', 'SGRSTTTextBuffer',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SLPPhoneIds',
    'SGLexicalNoSpecialChars', 'DISPID_SDKSetLongValue',
    'SAFT16kHz16BitStereo', 'DISPID_SpeechPhraseInfo',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SVEViseme', 'DISPID_SBSSeek',
    'SPCT_DICTATION', 'SP_VISEME_15', 'SpeechFormatType',
    'ISequentialStream', 'DISPID_SAFGetWaveFormatEx', 'ISpPhraseAlt',
    'SPGS_ENABLED', 'SpeechEngineConfidence', 'DISPID_SGRClear',
    'SPAUDIOSTATUS', 'SAFT11kHz16BitMono', 'eLEXTYPE_PRIVATE19',
    'SVSFParseAutodetect', 'SpMMAudioIn', 'SWTDeleted',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVGetVoices',
    'SpeechWordType', 'SGRSTTEpsilon', 'SVSFParseSapi',
    'SpMMAudioOut', 'Speech_StreamPos_RealTime', 'SGDSInactive',
    'DISPID_SpeechAudioStatus', 'SGDSActiveWithAutoPause',
    'ISpeechMMSysAudio', 'SVSFPurgeBeforeSpeak', 'SpeechAudioState',
    'SAFTNonStandardFormat', 'DISPID_SPIStartTime',
    'ISpeechGrammarRuleStateTransitions', 'SVSFNLPMask',
    'DISPIDSPTSI', 'STCLocalServer', 'DISPID_SFSClose',
    'SpeechMicTraining', 'SVP_21', 'SFTSREngine',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SpeechPhraseBuilder',
    ...
    'DISPID_SGRSAddRuleTransition', 'SAFT16kHz8BitMono',
    'DISPID_SPCPhoneToId', 'ISpeechLexiconPronunciations',
    'DISPID_SDKEnumValues',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SVSkip',
    'SpCompressedLexicon', 'SPPS_Verb', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpUnCompressedLexicon', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRCESoundEnd', 'SP_VISEME_10', 'SPEI_RESERVED2',
    'ISpeechResourceLoader', 'SPFILEMODE', 'SPGS_EXCLUSIVE',
    'SAFT44kHz8BitMono', 'STCAll', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVGetAudioInputs', 'WAVEFORMATEX', 'SP_VISEME_11',
    'DISPID_SpeechCustomStream', 'DISPID_SPIAudioSizeBytes',
    'ISpStream', 'DISPID_SRGDictationSetState', 'SREStreamEnd',
    'SPRST_INACTIVE', 'SpeechSpecialTransitionType', 'DISPID_SPRText',
    'DISPID_SpeechRecoContext', 'SREPropertyStringChange',
    'SPEI_PHONEME', 'SPAUDIOBUFFERINFO', 'eLEXTYPE_PRIVATE18',
    'SPBINARYGRAMMAR', 'SPPROPERTYINFO', 'SPPS_RESERVED2',
    'DISPID_SpeechVoiceEvent', 'SpeechCategoryPhoneConverters',
    'SPINTERFERENCE_TOOLOUD', 'ISpeechAudioFormat', 'SASPause',
    'SPINTERFERENCE_TOOQUIET', 'SPEI_TTS_PRIVATE',
    'SPSHORTCUTPAIRLIST', 'DISPID_SPPParent',
    'SpeechCategoryRecognizers', 'DISPID_SRCVoice',
    'DISPID_SRCEPhraseStart', 'SPRS_ACTIVE', 'SVSFIsXML',
    'DISPID_SPEDisplayAttributes', 'SPSLMA', 'DISPID_SLWsCount',
    'SREInterference', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpInprocRecognizer', 'SpeechDiscardType', 'DISPID_SRState',
    'DISPID_SpeechRecoContextEvents',
    'DISPID_SRCERecognitionForOtherContext', 'eLEXTYPE_PRIVATE16',
    'SVP_8', 'SVP_7', 'DISPID_SRGIsPronounceable',
    'SAFT32kHz16BitMono', 'DISPID_SVAlertBoundary', 'DISPID_SLWWord',
    'SVEPhoneme', 'DISPID_SPPNumberOfElements', 'SP_VISEME_5',
    'SP_VISEME_17', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRSetPropertyString', 'SpeechPropertyAdaptationOn',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpeechBaseStream',
    'DISPID_SpeechPhraseProperties', 'SRARoot',
    'DISPID_SRIsUISupported', 'SPEI_RESERVED3', 'DISPID_SPIRule',
    'DISPID_SpeechPhraseRule', 'DISPID_SDKGetBinaryValue',
    'SGRSTTWildcard', 'SVP_9', 'SAFTCCITT_ALaw_22kHzMono',
    'SRCS_Enabled', 'DISPID_SGRSTPropertyName',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpeechVoice',
    'SDA_One_Trailing_Space', 'DISPID_SASFreeBufferSpace',
    'SAFT8kHz8BitStereo', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SGRAttributes', 'DISPID_SVSpeakCompleteEvent',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechDictationTopicSpelling',
    'ISpeechMemoryStream', 'IEnumString',
    'DISPID_SRCAudioInInterferenceStatus', 'SPCATEGORYTYPE',
    'SPSSuppressWord', 'ISpPhoneticAlphabetSelection',
    'SECFNoSpecialChars', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SpeechRecoResult2', 'SPAO_RETAIN_AUDIO',
    'DISPID_SPRuleChildren', 'DISPID_SLGetWords', 'SPSNoun',
    'SP_VISEME_6', 'DISPID_SRSNumberOfActiveRules',
    'SpeechTokenKeyUI', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SpeechRecognizerStatus', 'SFTInput',
    'DISPID_SLPs_NewEnum', 'DISPID_SVDisplayUI',
    'DISPID_SPIReplacements', 'SRAExport', 'SPSHORTCUTPAIR',
    'ISpRecognizer2', 'SVP_2', 'SASClosed', 'SDTReplacement',
    'DISPID_SPISaveToMemory', 'DISPID_SVSInputSentenceLength',
    'SpeechStreamSeekPositionType', 'DISPID_SPEDisplayText',
    'DISPID_SLPLangId', 'DISPID_SVEPhoneme', 'SPDATAKEYLOCATION',
    'ISpeechWaveFormatEx', 'DISPID_SRIsShared',
    'DISPID_SRCreateRecoContext', 'SpeechAudioFormatGUIDText',
    'DISPID_SRCEAudioLevel', 'SPVISEMES', 'DISPID_SOTCategory',
    'SAFTADPCM_22kHzStereo', 'SWTAdded', 'DISPID_SGRAddResource',
    'DISPID_SpeechGrammarRules', 'DISPID_SRStatus',
    'DISPID_SDKGetStringValue', 'DISPID_SDKDeleteKey',
    'SAFTNoAssignedFormat', 'ISpeechRecognizerStatus',
    'DISPID_SRCEAdaptation', 'SRSActiveAlways', 'SPWF_INPUT', 'SVP_3',
    'SRADefaultToActive', 'SpeechDataKeyLocation', 'SPRULESTATE',
    'SPWF_SRENGINE', 'SPEI_PROPERTY_STRING_CHANGE', 'SRERecognition',
    'DISPID_SpeechGrammarRuleState', 'SPTEXTSELECTIONINFO',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPDKL_CurrentUser', 'SGRSTTWord',
    'SVP_11', 'SPRST_INACTIVE_WITH_PURGE', 'SPEI_INTERFERENCE',
    'DISPID_SLWPronunciations', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPRNumberOfElements', 'ISpeechPhraseElement',
    'eWORDTYPE_ADDED', 'SAFT32kHz8BitStereo', 'DISPID_SVResume',
    'eLEXTYPE_PRIVATE4', 'SPBO_PAUSE', 'DISPID_SDKDeleteValue',
    'tagSTATSTG', 'SAFTCCITT_uLaw_8kHzMono',
    'SpeechAudioFormatGUIDWave', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRGReset', 'DISPID_SRCEHypothesis', 'SPWAVEFORMATTYPE',
    'SVSFIsNotXML', 'ISpeechRecoResult2', 'SAFT22kHz16BitMono',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPCLangId',
    'DISPID_SGRsFindRule', 'SLOStatic', 'SpeechCategoryRecoProfiles',
    'DISPID_SRGCmdSetRuleState', 'SPSVerb', 'ISpShortcut',
    'DISPID_SABIMinNotification', 'DISPID_SRGSetWordSequenceData',
    'ISpDataKey', 'DISPID_SRDisplayUI',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpRecoGrammar2',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPERetainedStreamOffset',
    'SpeechLoadOption', 'DISPID_SRCCreateResultFromMemory',
    'SVSFParseMask', 'SpNotifyTranslator', 'DISPID_SPIGrammarId',
    '__MIDL_IWinTypes_0009', 'SAFT24kHz16BitStereo', 'SP_VISEME_4',
    'SPAR_High', 'SDTDisplayText', 'SPLEXICONTYPE',
    'eLEXTYPE_PRIVATE20', 'ISpeechAudioStatus',
    'ISpPhoneticAlphabetConverter', 'SVF_None',
    'DISPID_SPELexicalForm', 'DISPID_SVSVisemeId',
    'SpeechStreamFileMode', 'eLEXTYPE_USER', 'SPINTERFERENCE',
    'ISpeechRecoResultTimes', 'ISpRecoResult',
    'DISPID_SWFEBlockAlign', 'ISpeechLexiconWords',
    'DISPID_SLPsCount', 'SPEI_VISEME', 'SPRST_ACTIVE_ALWAYS',
    'SDA_Consume_Leading_Spaces', 'SpeechCategoryAppLexicons',
    'DISPID_SGRSAddWordTransition', 'tagSPPROPERTYINFO', 'SGRSTTRule',
    'DISPID_SRGDictationLoad', 'DISPID_SABufferNotifySize',
    'SWPUnknownWordUnpronounceable', 'SPADAPTATIONRELEVANCE',
    'SRTSMLTimeout', 'SDTAudio', 'SVP_6', 'DISPID_SPIProperties',
    'DISPID_SABufferInfo', 'DISPID_SLRemovePronunciation',
    'eLEXTYPE_RESERVED4', 'SPCS_ENABLED', 'SPLO_STATIC',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPAS_RUN',
    'ISpeechXMLRecoResult', 'SAFTExtendedAudioFormat',
    'DISPID_SPEsCount', 'ISpeechObjectTokenCategory',
    'DISPID_SRGetPropertyNumber', 'DISPID_SAVolume',
    'ISpeechPhraseAlternates', 'DISPID_SRCEEnginePrivate',
    'DISPID_SAEventHandle', 'SpeechVoiceEvents',
    'DISPID_SRCRetainedAudio', '_SPAUDIOSTATE', 'DISPID_SRGRules',
    'SpeechRuleState', 'SpInProcRecoContext',
    'ISpObjectTokenCategory', 'IInternetSecurityMgrSite',
    'SpPhoneticAlphabetConverter', 'SAFT44kHz8BitStereo',
    'SAFTADPCM_11kHzStereo', 'SPPS_SuppressWord',
    'SPEI_RECO_STATE_CHANGE', 'SP_VISEME_14', 'SpeechAllElements',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPCT_SUB_COMMAND',
    'DISPID_SLWType', 'ISpeechPhraseAlternate',
    'SpObjectTokenCategory', 'ISpRecoCategory',
    'DISPID_SpeechRecoResult', 'DISPID_SVPriority', 'DISPID_SGRsAdd',
    'DISPID_SPCIdToPhone', 'SPEVENTENUM', 'SREPhraseStart',
    '_RemotableHandle', 'SAFT16kHz8BitStereo',
    'DISPID_SRCRequestedUIType', 'SREBookmark',
    'DISPID_SPEEngineConfidence', 'DISPID_SpeechXMLRecoResult',
    'ISpRecoContext', 'ISpProperties', 'SPSHT_NotOverriden',
    'SPFM_NUM_MODES', 'SECHighConfidence', 'SpWaveFormatEx',
    'eLEXTYPE_RESERVED7', 'ISpeechPhraseProperty', 'SPCT_COMMAND',
    'SpeechPartOfSpeech', 'SSFMOpenReadWrite',
    'DISPID_SPRuleEngineConfidence', 'eLEXTYPE_PRIVATE2',
    'DISPID_SVEStreamEnd', 'SECNormalConfidence',
    'DISPID_SPEs_NewEnum', 'DISPID_SVEAudioLevel',
    'SpSharedRecoContext', 'DISPID_SPRs_NewEnum', 'SPAS_PAUSE',
    'SPPHRASEELEMENT', 'DISPID_SVSPhonemeId', 'DISPID_SWFEFormatTag',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRCBookmark',
    'DISPID_SVSInputWordPosition', 'DISPID_SPACommit',
    'SpeechEmulationCompareFlags', 'DISPID_SPILanguageId',
    'SpeechGrammarRuleStateTransitionType', 'SPEI_MAX_SR',
    'eLEXTYPE_PRIVATE15', 'DISPID_SVSpeakStream', 'SPEI_ADAPTATION',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVPOver',
    'DISPID_SVEVoiceChange', 'SPRST_ACTIVE', 'SpeechAudioProperties',
    'DISPID_SRRSpeakAudio', 'SGLexical', 'DISPID_SRGCommit',
    'DISPID_SPRuleFirstElement', 'DISPID_SpeechLexiconWords',
    'DISPID_SRCERecognition', 'SPAUDIOOPTIONS', 'SLTApp',
    'DISPID_SWFESamplesPerSec', 'SpSharedRecognizer',
    'DISPID_SGRsDynamic', 'SAFTADPCM_22kHzMono', 'SPAR_Unknown',
    'DISPID_SPEPronunciation', 'DISPID_SRCRecognizer',
    'SGDSActiveUserDelimited', 'DISPID_SRGetRecognizers',
    'ISpeechRecoGrammar', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVAudioOutputStream', 'UINT_PTR', 'SAFT44kHz16BitMono',
    'SAFT48kHz16BitMono', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SGRSTText', 'DISPID_SPPId', 'DISPID_SRRSaveToMemory',
    'SPSHORTCUTTYPE', 'DISPID_SpeechObjectTokens', 'SPBO_NONE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPWORDPRONUNCIATION',
    'SAFTADPCM_8kHzMono', 'SpeechPropertyResourceUsage',
    'DISPID_SGRsCount', 'DISPID_SRRTimes', 'DISPID_SpeechVoice',
    'IEnumSpObjectTokens', 'ISpeechPhraseElements',
    'DISPID_SLGetPronunciations', 'SpeechVoicePriority',
    'DISPID_SPIAudioSizeTime', 'SPXMLRESULTOPTIONS',
    'SpeechRetainedAudioOptions', 'SpeechRegistryLocalMachineRoot',
    'SAFTCCITT_uLaw_44kHzMono', 'Speech_Max_Pron_Length',
    'DISPID_SGRSTPropertyValue', 'SECFDefault', 'SRAImport',
    'SP_VISEME_20', 'SPFM_CREATE_ALWAYS', 'DISPID_SGRs_NewEnum',
    'eLEXTYPE_RESERVED10', 'DISPID_SRCCmdMaxAlternates',
    ...
    'SPXRO_SML', 'ISpEventSink', 'DISPID_SPAs_NewEnum',
    'DISPID_SVRate', 'SP_VISEME_8', 'SpeechAddRemoveWord',
    'SPINTERFERENCE_NONE', 'DISPID_SPRsCount', 'SPCT_SLEEP',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechWaveFormatEx',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVP_20', 'SAFT22kHz8BitMono',
    'DISPID_SPPsCount', 'DISPID_SLPPartOfSpeech', 'SPPS_RESERVED1',
    'DISPID_SRCCreateGrammar', 'SPRECOSTATE', 'DISPID_SPPConfidence',
    'SVP_16', 'SpeechTokenKeyAttributes', 'SVP_18',
    'ISpeechPhraseInfo', 'ISpEventSource', 'SDA_Two_Trailing_Spaces',
    'SVEAudioLevel', 'SAFT32kHz16BitStereo', 'DISPID_SLPType',
    'DISPID_SRSClsidEngine', 'SPSERIALIZEDRESULT', 'DISPID_SPRuleId',
    'SPWORDPRONOUNCEABLE', 'ISpSerializeState', 'SPFM_OPEN_READWRITE',
    'SVESentenceBoundary', 'SINoSignal', 'SPSModifier',
    'SpeechTokenContext', 'DISPID_SMSALineId', 'SPFM_CREATE',
    'DISPID_SVEStreamStart', 'SAFT44kHz16BitStereo',
    'SPEI_END_SR_STREAM', 'DISPID_SOTs_NewEnum', 'SVSFlagsAsync',
    'SVSFParseSsml', 'SWPUnknownWordPronounceable',
    'ISpeechGrammarRule', 'SPEI_RESERVED5', 'SPWT_PRONUNCIATION',
    'DISPID_SOTDisplayUI', 'SDTLexicalForm', 'SP_VISEME_3',
    'DISPID_SRRAlternates', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRGCmdSetRuleIdState', 'SVP_14', 'DISPID_SLWLangId',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPEVENTSOURCEINFO',
    'SpeechGrammarTagWildcard', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SASCurrentSeekPosition', 'SPRECORESULTTIMES',
    'DISPID_SpeechLexiconPronunciation', 'SAFTADPCM_11kHzMono',
    'SAFTGSM610_22kHzMono', 'SpAudioFormat', 'SpeechCategoryAudioOut',
